oc new-project $1
sed 's|REPLACE_NAMESPACE|$1|g' squash.v0.3.1.clusterserviceversion.yaml > squash.v0.3.1.clusterserviceversion-dev.yaml
oc create -f squash.v0.3.1.clusterserviceversion-dev.yaml
sed 's|REPLACE_NAMESPACE|$1|g' squash-subscription.yaml > squash-subscription-dev.yaml
